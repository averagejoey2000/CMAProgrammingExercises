...
The mean pulse of men is `r mean(data$Gender=="Male")` Beats per minute.
**The mean for pulse rates of Females is ** 

The mean pulse of women is `r mean(data$Gender=="Female")` Beats per minute.
**Compare these means: ** 
